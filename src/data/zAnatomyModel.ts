...
export const Z_ANATOMY_ASSETS: ZAnatomyAsset[] = [
  ...
  // The vertex-colour export preserves the detailed facial-muscle material.
  // This complete atlas export supplements it with the individually named
  // trunk and limb muscles that are not present in that compact preview.
